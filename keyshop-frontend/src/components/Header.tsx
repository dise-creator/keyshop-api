...
// Градиенты для каждой платформы
const platformConfig: Record<string, { gradient: string; svg: React.ReactElement }> = {
  playstation: {
...
export default function Header({ platforms, activePlatform, onPlatformChange, theme, onToggleTheme }: HeaderProps) {
  return (
    <>
      {/* Хедер: логотип + тумблер */}
